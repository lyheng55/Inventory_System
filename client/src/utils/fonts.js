 ...
 * @param {string} languageCode - Language code (e.g., 'en', 'km')
 * @returns {string} Font family string
 */
export const getFontFamily = (languageCode = 'en') => {
 ...
 * @returns {string} Font family string
 */
export const getMonospaceFontFamily = (languageCode = 'en') => {
 ...
 * @param {string} languageCode - Language code (e.g., 'en', 'km')
 * @returns {object} Font styles object
 */
export const getFontStyles = (languageCode = 'en') => {
 ...
 * @param {string} languageCode - Language code (e.g., 'en', 'km')
 */
export const applyGlobalFont = (languageCode = 'en') => {
  const fontFamily = getFontFamily(languageCode);
 ...
 */
export const getFontCSSVariables = (languageCode = 'en') => {
  return {
